...
try:
    from .opra_cache import DATABASE_FILENAME, OpraCacheManager  # type: ignore
except ImportError:  # pragma: no cover - fallback for script execution
    from opra_cache import DATABASE_FILENAME, OpraCacheManager  # noqa: E402

try:
    from scripts.modern_target import MODERN_TARGET_CORRECTION_BAND
except ImportError:  # pragma: no cover - fallback for direct execution
    from modern_target import MODERN_TARGET_CORRECTION_BAND  # noqa: E402

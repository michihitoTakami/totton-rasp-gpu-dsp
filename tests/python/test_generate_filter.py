...
class TestCoefficientFileLoading:
    ...
    def test_load_44k_16x_coefficients(self, coefficients_dir):
        ...
        coeff_path = coefficients_dir / "filter_44k_16x_80000_min_phase.bin"
    ...
    def test_load_48k_16x_coefficients(self, coefficients_dir):
        ...
        coeff_path = coefficients_dir / "filter_48k_16x_80000_min_phase.bin"
...
class TestCoefficientFileNaming:
    """Tests for coefficient file naming convention (80000 taps)."""

    # Expected filenames for all 8 multi-rate configurations
    EXPECTED_FILENAMES = [
        "filter_44k_16x_80000_min_phase.bin",
        "filter_44k_8x_80000_min_phase.bin",
        "filter_44k_4x_80000_min_phase.bin",
        "filter_44k_2x_80000_min_phase.bin",
        "filter_48k_16x_80000_min_phase.bin",
        "filter_48k_8x_80000_min_phase.bin",
        "filter_48k_4x_80000_min_phase.bin",
        "filter_48k_2x_80000_min_phase.bin",
    ]

    def test_all_coefficient_files_exist(self, coefficients_dir):
        """All 8 coefficient files should exist with 80000-tap naming."""
        missing_files = []
    ...
    def test_coefficient_filenames_use_80000_format(self, coefficients_dir):
        """Coefficient files should use numeric tap counts in filenames."""
        new_format_files = list(coefficients_dir.glob("*_80000_*.bin"))
        assert (
            len(new_format_files) >= 8
        ), f"Expected at least 8 files with '80000' naming, found {len(new_format_files)}"
...
class TestCoefficientDcGain:
    ...
    def test_coefficient_dc_matches_target(self):
        ...
        cases = [
            ("filter_44k_16x_80000_min_phase.bin", 16.0 * 0.99),  # 15.84
            ("filter_48k_16x_80000_min_phase.bin", 16.0 * 0.99),  # 15.84
            ("filter_44k_8x_80000_min_phase.bin", 8.0 * 0.99),  # 7.92
            ("filter_48k_8x_80000_min_phase.bin", 8.0 * 0.99),  # 7.92
        ]
